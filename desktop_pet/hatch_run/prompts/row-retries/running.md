Create Codex pet row `running` for `girlfriend`: exactly 6 full-body frames in one horizontal strip on flat pure green #00FF00.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: 年轻女性Q版人物，短深色波波头，透明圆框眼镜，黑色上衣，浅灰蓝色连帽外套，浅水洗蓝色宽松牛仔裤，白色运动鞋；将原嘟嘴改为温柔开心、略带俏皮的自然微笑；保持完整人物和统一身份. Preserve silhouette, face, palette, material, proportions, markings, and props.
