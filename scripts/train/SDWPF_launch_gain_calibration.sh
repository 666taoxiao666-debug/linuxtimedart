...
parameters="h${pred_len}_f${FOLD}_s${SEED}_blocks${GAIN_BLOCKS}_min${GAIN_MIN_WINDOWS}_pen${GAIN_PENALTY}_sparse_events"
sdwpf_log_init wiki_gain_calibration "$parameters" launch.log "gain_sparse_$(date +%Y%m%d_%H%M%S)_$$"
{
