...
LOG_PARAMETERS="utility${UTILITY_WIKI}_h${PRED_LEN}_${SPLIT}_3seed_blr${FINETUNE_LEARNING_RATE}_nlr${NEW_MODULE_LEARNING_RATE}_mix${MIX_MSE_WEIGHT}_${PROMPT_ROUTER}_ulw${UTILITY_LOSS_WEIGHT}_ugt${UTILITY_GATE_TEMPERATURE}_umg${UTILITY_MIN_GAIN}_reg${REGIME_LABEL_METHOD}_rq${REGIME_CALIBRATION_QUANTILE}"
