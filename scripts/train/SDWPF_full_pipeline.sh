...
LOG_PARAMETERS="h${PRED_LEN}_${SPLIT}_f${FOLD}of${N_FOLDS}_s${SEED}_pt${PRETRAIN_PRED_LEN}_pte${PRETRAIN_EPOCHS}_ptlr${PRETRAIN_LEARNING_RATE}_fte${FINETUNE_EPOCHS}_blr${FINETUNE_LEARNING_RATE}_nlr${NEW_MODULE_LEARNING_RATE}_mix${MIX_MSE_WEIGHT}_reg${REGIME_LABEL_METHOD}_rq${REGIME_CALIBRATION_QUANTILE}"
