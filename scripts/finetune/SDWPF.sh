...
# 每次运行默认生成独立 RUN_ID，避免 checkpoint / 测试结果互相覆盖。
# 示例：
#   LOSS=MIXED POWER_WEIGHT_ALPHA=0.5 bash scripts/finetune/SDWPF.sh
#   RUN_ID=ablation_a LOSS=MIXED bash scripts/finetune/SDWPF.sh
SEED="${SEED:-2024}"
LOSS="${LOSS:-MSE}"
